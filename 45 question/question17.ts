let guestList: string[] = ["Danish", "Ali", "Hamza", "Ahmed", "Asma", "Ubaid"];
...
for (let i = 0; i < guestList.length; i++) {
    console.log(`Dear ${guestList[i]}, you are still invited to dinner. I would be honored by your presence.`);
}
